/*
 Original Author: jim teeuwen <jimteeuwen@gmail.com>
 Temporary Maintenar: Yasuhiro Matsumoto <mattn.jp@gmail.com>
 Dependencies: go-pkg-xmlx (http://github.com/mattn/go-pkg-xmlx)
